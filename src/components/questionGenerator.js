...
/* const QuestionGenerator = forwardRef((props, _ref) => { {/* 1 */ /* 8 - React recalls QuestionGenerator to get updated JSX 
    const [question, setQuestion] = useState(); {/* 2 */ /* 3 - QuestionGenerator, your code, binds that initial value ("2+2") to the local variable question, 
